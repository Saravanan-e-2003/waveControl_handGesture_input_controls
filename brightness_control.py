...
def change_brightness():
    ...
    while True:
        ...
        # cv2.rectangle(image, (0, 0), (screen_width, center_y), (0, 0, 0), 1)
        # cv2.rectangle(image, (0, center_y), (screen_width, r_center_y), (0, 0, 0), 1)
        # cv2.rectangle(image, (0, r_center_y), (screen_width, f_center_y), (0, 0, 0), 1)
